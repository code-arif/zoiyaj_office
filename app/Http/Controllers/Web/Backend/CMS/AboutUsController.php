...
class AboutUsController extends Controller
{
    ...
    public $name = "home";
    public $section = "about_us";
    public $page = PageEnum::HOME;
    public $item = SectionEnum::HOME_ABOUT_US;
    public $items = SectionEnum::HOME_ABOUT_USS;
    public $count = 20;
    ...
    public function content(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'third_description'       => 'nullable|string',
            'forth_description'       => 'nullable|string',
